...
<div class="header">
    ...
    <div class="container">
        ...
        <div class="logo">
            <h1><a href="index.php">Coffee Shop<span>The Best Coffee Shop</span></a></h1>
        </div>
        <div class="head-t">
            <ul class="card">
        ...
        <div class="form-w3agile form1">
            ...
            <form action="register-user.php" method="post">
                <div class="key">
                    ...
                    <input type="text" value="username" id="username" name="username" onfocus="this.value = '';"
                           onblur="if (this.value == '') {this.value = 'Username';}" required="">
                    <div class="clearfix"></div>
                </div>
                <div class="key">
                    <i class="fa fa-envelope" aria-hidden="true"></i>
                    <input type="email" value="email" name="email" id="email" onfocus="this.value = '';"
                ...
                <div class="key">
                    <i class="fa fa-lock" aria-hidden="true"></i>
                    <input type="password" value="confirm Password" name="confirm_Password" id="confirm_Password" onfocus="this.value = '';"
