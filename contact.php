    ...
    <div class="container">
        ...
        <div class=" contact-w3">
            <div class="col-md-5 contact-right">
                <img src="images/contact%20image.jpg" class="img-responsive" alt="coffee_image_1">
                <img src="images/slide3.jpg" class="img-responsive" alt="coffee_image_2">
            </div>
            <div class="col-md-7 contact-left">
                <h4>Contact Information</h4>
                <p> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus accusantium animi consequuntur,
                    debitis ducimus ex harum ipsa itaque minus, molestiae placeat quae quasi recusandae saepe sed
                    tempora temporibus unde vel.</p>
                <ul class="contact-list">
                    <li><i class="fa fa-map-marker" aria-hidden="true"></i> Address</li>
                    <li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:example@mail.com">youremail@example.com</a>
                    </li>
                    <li><i class="fa fa-phone" aria-hidden="true"></i>011 2345678</li>
                </ul>
                <div id="container">
                    <!--Horizontal Tab-->
                        ...
                        <div class="resp-tabs-container hor_1">
                            ...
                            <div>
                                <div class="map-grid">
                                    <h5>Our Branches</h5>
                                    <ul>
                                        <li><i class="fa fa-arrow-right" aria-hidden="true"></i>Address
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div>
                                <div class="map-grid">
                                    ...
                                    <ul>
                                        <li>Mobile No : 011 1111111</li>
                                        <li>Office No : 011 1111111</li>
                                        <li>Home No : 011 1111111</li>
                                        <li>Fax No : 011 1111111</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
